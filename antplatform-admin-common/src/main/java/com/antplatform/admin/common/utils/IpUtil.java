 ...
 */
public class IpUtil extends StringUtils {
...
//
        System.out.println(FormatUtil.formatBytes(Runtime.getRuntime().totalMemory()));
...
//        Date date1 = DataUtil.getNowDate();
//        Date date2 = DataUtil.getNowDate();
//        System.out.println("time:"+DataUtil.getDatePoor(date1,date2, Constant.TimeType.HOUR));
    }
}
