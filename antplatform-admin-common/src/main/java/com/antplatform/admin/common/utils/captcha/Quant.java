...
public class Quant {
    ...
    /**
     * minimum size for input image, minpicturebytes = 1509
     */
    ...
    /**
     * for 256 cols, radius starts, initrad = 32
     */
    ...
    /**
     * and decreases by a, initradius = 2048
     */
    ...
    protected int contest(int b, int g, int r) {
        ...
        for (int i = 0; i < netsize; i++) {
            ...
            int biasdist = dist - ((this.bias[i]) >> (intbiasshift - netbiasshift));
            if (biasdist < bestbiasd) {
                bestbiasd = biasdist;
                bestbiaspos = i;
            }
            int betafreq = this.freq[i] >> betashift;
