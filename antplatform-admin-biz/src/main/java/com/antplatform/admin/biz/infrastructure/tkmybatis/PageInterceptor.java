...
import com.antplatform.admin.biz.infrastructure.dialect.Dialect;
import com.antplatform.admin.biz.infrastructure.tkmybatis.ext.TKMybatisConfiguration;
import com.antplatform.admin.biz.utils.DaoContextHolder;
import com.antplatform.admin.biz.utils.ReflectionUtils;
...
public class PageInterceptor implements Interceptor {
    ...
    private TKMybatisConfiguration config;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (rowBound != null) {
            ...
            if (rb.getOffset() == RowBounds.NO_ROW_OFFSET && rb.getLimit() == RowBounds.NO_ROW_LIMIT) {
                ...
                // if (Example.class.isAssignableFrom(args[1].getClass())) {
                //     config.getMapperHelper().getMapperTemplateByMsId(ms.getId()).setSqlSource(ms);
